...
function Index() {
    ...
    return (
        <>
            <div className="container-fluid ps-5 pe-5 mt-4">
                <div className="text-end">
                    ตะกร้าสินค้า : <button className="btn btn-success">
            ...
            <div className="text-center h3 mt-3 mt-5"> Lottery </div>
            ...
            <div className="mt-3 container-fluid ps-5 pe-5 mb-5">
                <div className="row">
                    {lottos.length > 0 ? lottos.map(item =>
                        <div className="col-3" key={item.number}>
                            <div className="card mt-3">
                                <div className="card-body text-center">
                                    <div className="h3 text-info">{item.number}</div>
                                    <div className="text-success h5">{item.sale} บาท</div>
                                    <div className="mt-3">
                                        <button onClick={(e) => handleAddToCart(item)} className=" btn btn-warning">
                                            <i className="fa fa-shopping-cart me-2"></i>
                                            เลือกซื้อ
                                        </button>
                                    </div>
                            ...
                            <div className="mt-3">
                                ...
                                <div className="mt-3">
                                    <button onClick={handleComfirmBuy} className="btn btn-primary">
                                        <i className="fa fa-check me-2"></i>ส่งข้อมูล
                                    </button>
                                </div>
