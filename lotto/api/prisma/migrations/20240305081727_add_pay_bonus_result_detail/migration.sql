/*
  ...
  - Added the required column `bonusData` to the `BonusResultDetail` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "bonusData" TIMESTAMP(3) NOT NULL,
